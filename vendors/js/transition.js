...
(function (root, factory) {
    ...
    transition.prototype.jumpTo = function (animation, jump) {
        if (this.option.isAnimating) {
            return false;
        }

        if(jump === this.option.current){
            return false;
        } else if(jump < this.option.current) {
            animation = 2;
        } else if (jump > this.option.current){
            animation = 1;
        } else {
    ...
    transition.prototype.nextPage = function (animation) {
        console.log("Next button Clicked: up" + this.option.isAnimating);
        if (this.option.isAnimating) {
            return false;
        }
        ...
        });console.log("Next button Clicked: down " + this.option.isAnimating);
    };
